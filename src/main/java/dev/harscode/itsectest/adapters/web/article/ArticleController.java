...
public class ArticleController {
    ...
    public ResponseEntity<ApiResponse<ArticleResponse>> create(
        ...
        permission.resolveScope(userId, userRole, ArticleAction.CREATE);
    ...
    public ResponseEntity<ApiResponse<ArticleResponse>> getById(
        ...
        ArticleScope scope = permission.resolveScope(userId, userRole, ArticleAction.GET);
        UUID authorId = null;
        String status = null;
        switch (scope) {
    ...
    public ResponseEntity<ApiResponse<ArticleListResponse>> list(
        ...
        ArticleScope scope = permission.resolveScope(userId, userRole, ArticleAction.LIST);
        switch (scope) {
            case OWN_ONLY -> authorId = userId;
            case PUBLIC_ONLY -> status = "published";
        }
    ...
    public ResponseEntity<ApiResponse<ArticleResponse>> update(
        ...
        ArticleScope scope = permission.resolveScope(userId, userRole, ArticleAction.UPDATE);
        UUID authorId = null;
    ...
    public ResponseEntity<ApiResponse<Void>> delete(
        ...
        ArticleScope scope = permission.resolveScope(userId, userRole, ArticleAction.DELETE);
        UUID authorId = null;
        if (Objects.requireNonNull(scope) == ArticleScope.OWN_ONLY) {
            authorId = userId;
        }
